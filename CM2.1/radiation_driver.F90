...
use constants_mod,         only: constants_init, RDGAS, RVGAS,   &
                                 ...
                                 RADIAN, diffac, &
                                 PI    ! 042018[ZS]: constant used to calculate local forcing
...
real        :: solar_forcing_center1 = 0.0
real        :: solar_forcing_width1 = 30.0
...
namelist /radiation_driver_nml/ do_radiation, &
                                ...
                                cosp_precip_sources, &
                                add_solar_forcing, & ! 042018[ZS]: add solar forcing parameters
                                solar_forcing_mag1, solar_forcing_center1, solar_forcing_width1, &
                                solar_forcing_sf1, &
                                solar_forcing_mag2, solar_forcing_center2, solar_forcing_width2, &
                                solar_forcing_sf2
!---------------------------------------------------------------------
!---- public data ----
...
! 042018[ZS]: perturb solar radiation
...
!---------------------------------------------------------------------
      ...
      !++ 042018[ZS]: add asymmetric forcing [052416]
      if (add_solar_forcing) then
      ...
      if (do_rad) then
        call radiation_calc (is, ie, js, je, lat, lon, &
                             ...
                             scaled_solar_forcing)  ! 042018[ZS])
      endif
...
real, dimension(:,:),          intent(in)            :: local_solar_forcing ! 042018[ZS]
